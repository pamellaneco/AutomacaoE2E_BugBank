describe('Funcionalidades Financeiras (Transferência e Extrato)', () => {

  let contaDestino;

  context('Transferências (Requer conta destino prévia)', () => {
  ...
  it('TTCW-7: Verificar registro de transferência no extrato', () => {
    ...
    // Validação (deve haver saldo inicial de 1000)
